 ...
 * Phase 3.1 — Tiered Rental Rate Matrix Engine (CORRECTED)
 *
 ...
 * default rates.
 *
 * Tier Boundaries (CORRECTED per Servepower sample & route-map-v2.docx):
...
/**
 * Canonical tier definitions (Phase 3.1 — CORRECTED)
 * Per Servepower sample quotation and route-map-v2.docx:
 *   - Daily: "For continues rental period of less than 6days" = 1–6 days
 *   - Weekly: "For continues rental period of 7days or less than 25 days" = 7–25 days
 *   - Monthly: "For continues rental period of 26days or more" = 26+ days
 */
const RATE_TIERS: RateTier[] = [
  { rateBasis: 'Daily', minDays: 1, maxDays: 6 },
  { rateBasis: 'Weekly', minDays: 7, maxDays: 25 },
